...
import com.example.micapp.ui.ViewAddressesCategoriesActivity
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnViewAddressesCategories: Button = findViewById(R.id.btn_view_addresses_categories)
        ...
        btnSaveReading.setOnClickListener {
            ...
            intent.putExtra("DECIBEL_READING", txtDecibel.text.toString()) // Pass the current decibel level
        ...
        // Navigate to ViewAddressesCategoriesActivity
        btnViewAddressesCategories.setOnClickListener {
            val intent = Intent(this, ViewAddressesCategoriesActivity::class.java)
            startActivity(intent)
        }
    }
